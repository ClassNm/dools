    ...
    <div>
        ...
        <div class="ui-box-container ui-box-zhiy">
            ...
            <table class="ui-table m_top10">
                ...
                <tbody>
                <tr>
                    <td style="width: 218px">个人陈述</td>
                    <td>
                        须考生用A4纸本人手写，字数限1000字以内，落款处考生本人签字，扫描或拍照上传至报名系统，内容必须包含以下4个方面：①人生观和价值观；②主要参与的实践活动（学生干部、公益活动等）及感悟；③对申报专业的认知以及大学学业规划；④学生自己做过的最有成就感的一件事情；以上作为四部分的标题。
                    </td>
                    <td>是</td>
                    <td>
                        <a href="javascript:;">添加</a>
                        <br><font color="red">必填项未填写</font>
                    </td>
                </tr>
                </tbody>
            </table>
