            ...
            <div class="ui-box-container">
                <div class="ui-tiptext-container ui-tiptext-container-message" style="margin-top:10px;">
                    <p class="ui-tiptext ui-tiptext-message" style="font-size:12px" align="left">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、请如实尽量填写各学期期末考试成绩，如果某科目在某学期没有成绩或没有排名，可以不填。<br>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、学业水平考试（会考）成绩请根据所在省市情况，如实填写A+、A、B+、B、B-、C+、C、C-、D+、D、E、合格、不合格或者分数。<br>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、<span style="color:#c30;">某些高校的志愿可能需要会考成绩。您可先将学业水平（会考）成绩填写完整，对学业水平（会考）没有的科目可以填“无”</span>。
                    </p>
                </div>
                <br>
