    ...
    <div>
        <div class="ui-box">
            ...
            <div class="ui-box-container">
                <form id="form_step"
                      name="form_step"
                      action="/zzbm/stu/tjr/savesch.action"
                      method="post"
                    ...
                    <div class="ui-form-item">
                        ...
                        <label for="" class="ui-label"><span class="ui-form-required">*</span><strong>所在地：</strong></label> 
...
import { secondarySchool } from '../../vuex/actions.js'
export default {
    data(){
        return{
             // 高考报名所在地
