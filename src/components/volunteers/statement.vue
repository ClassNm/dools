            ...
            <form id="grcs" name="grcs" action="" method="">
                <div class="ui-form-item">
                    ...
                    <p class="ui-form-text">
                        <textarea name="grcs" cols="" rows="" id="" class="ui-textarea" style="width:654px; height:200px"></textarea>
                    </p><div class="ui-tiptext-container ui-tiptext-container-wait" style="margin-top:6px;">
